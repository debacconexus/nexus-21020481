...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Child Welfare Fatal Abuse Prevention System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "ChildWelfareCase";
process.env.TABLE_NAME = process.env.TABLE_NAME || "childwelfarecase_records";
'use strict';
